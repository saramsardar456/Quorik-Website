...
export function generateSmartDemoData(businessQuery: string): Partial<DemoSiteData> {
  ...
  if (q.includes('vet') || q.includes('pet') || q.includes('dog') || q.includes('cat') || q.includes('animal')) {
    return {
      ...
      reviews: [
        { name: 'Jessica Vance', role: 'Golden Retriever Mom', rating: 5, comment: 'Called at midnight in a panic when Milo ate chocolate. Arthur triaged him calmly and had a room ready!' },
