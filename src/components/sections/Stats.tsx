      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-8">
          {stats.map((stat, i) => (
            ...
            >
              <div className="text-5xl md:text-7xl font-bold text-white tracking-tighter mb-2 flex items-baseline">
                {stat.value}<span className="text-brand-teal text-3xl md:text-5xl">{stat.suffix}</span>
              </div>
